...
restartbuton=createSprite(200,500,50,50)
restartbuton.shapeColor="blue"
restartbuton.visible=false
}
function draw(){
  if(gameState===0){
    fondo1.visible=true
...
if(gameState===2){
  ...
  loste();
lost.visible=true
restartbuton.visible=true


textSize(25)
fill("black")
text("score: "+score,200,200)
  if(mousePressedOver(restartbuton)){
    gameState=0
    score=0
